...
ElementalBeams = True					#Switch to enable elemental beam types
HyperdriveBeams = True					#Switch to enable Hyperdrive-specific beam types
...
if SuperscienceBeams == True:				#Testing whether to add the vanilla superscience beams
	MasterBeamList.append([Force,Graviton])
...
if HyperdriveBeams == True:				#Testing whether to add Hyperdrive-specific beams
	MasterBeamList.extend([Cylconic,Ion])
...
class EnergyWeapon:
	...
	def getDamageString(self):
		return (GURPS.DiceRounder(self.damageDice) + self.getDivisorString() + " " + self.beamType.damageType)
...
Cyclonic = BeamType("Cyclonic beam")
Ion = BeamType("Ionic blaster",10,3.0,3,5,"burn sur",32,34,2000,3,["Superscience"])
